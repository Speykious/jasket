/**
 * Meneur de jeu est au centre est a comme capacité de faire beaucoup de passe (plus que la plupart des autre joueurs)
 */
public class PointGuard extends Player implements Guard {
  ...
  /**
   * crossover retourne quand le meneur a crossé (passer en dribblant) un joueur adverse
   * @param p Le joueur adverse
   * @return String
   */
